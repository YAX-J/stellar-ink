-- 开发种子数据（与前端 prototype 的 mock 数据对齐；仅 H2 dev 环境自动执行）
-- 文章正文取自原型的段落池，id 按新→旧排列（1 为最新）

INSERT INTO user (id, username, password, nickname, signature, avatar_text, daily_goal, created_at) VALUES
(1, 'stellar', '$2b$10$/Y2gZHVQbuUI8VDF96YrDONvBeVPz4H44LX2bTrrTTGeRaf1nZN4a', '拾星人', '在算法的洪流里，做一个缓慢的人。', '星', 500, '2024-03-07 23:00:00');

INSERT INTO post (id, title, content, tags, word_count, status, glow, created_at, updated_at) VALUES
(1, '在算法的洪流里，做一个缓慢的人',
...
INSERT INTO meteor (id, content, created_at) VALUES
(1, '便利店的关东煮，在凌晨两点最有尊严。', CURRENT_TIMESTAMP),
(2, '忽然明白：所谓成长，就是把“为什么是我”换成“接下来呢”。', CURRENT_TIMESTAMP),
(3, '楼下的猫今天允许我摸了三秒。历史性突破。', CURRENT_TIMESTAMP),
(4, '把待办清单烧掉一半，效率反而翻倍。', CURRENT_TIMESTAMP),
(5, '雨声是最好的白噪音，前提是屋里没漏。', CURRENT_TIMESTAMP);

INSERT INTO echo (id, nickname, content, created_at) VALUES
...
INSERT INTO link (id, name, url, description, status, created_at) VALUES
