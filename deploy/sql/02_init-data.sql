...
-- -------------------------------------------------------------
INSERT IGNORE INTO `post` (`id`, `title`, `content`, `tags`, `word_count`, `status`, `glow`, `created_at`, `updated_at`) VALUES
(1, '在算法的洪流里，做一个缓慢的人',
...
-- 流星备忘录
-- -------------------------------------------------------------
INSERT IGNORE INTO `meteor` (`id`, `content`, `created_at`) VALUES
(1, '便利店的关东煮，在凌晨两点最有尊严。', NOW()),
(2, '忽然明白：所谓成长，就是把“为什么是我”换成“接下来呢”。', NOW()),
(3, '楼下的猫今天允许我摸了三秒。历史性突破。', NOW()),
(4, '把待办清单烧掉一半，效率反而翻倍。', NOW()),
(5, '雨声是最好的白噪音，前提是屋里没漏。', NOW());
